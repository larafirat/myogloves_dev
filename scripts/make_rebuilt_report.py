"""Report for the REBUILT rig -- the one with a held wrist and a palm-opposed
grasp. Kept separate from make_benchmark_report.py, which still renders the
original floppy-wrist study; both sets of findings are worth keeping.

Usage:
    python myogloves_dev/scripts/make_rebuilt_report.py \
